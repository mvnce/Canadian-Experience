...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_EDIT_EDITHAROLDTEXTBUBBLE, &CMainFrame::OnEditEditharoldtextbubble)
	ON_COMMAND(ID_EDIT_EDITSPARTYTEXTBUBBLE, &CMainFrame::OnEditEditspartytextbubble)
END_MESSAGE_MAP()
...
void CMainFrame::Initialize()
{
	...
	mSpartyTextBubbleDrawable = factory.GetSpartyTextBubbleDrawable();
...
/** \brief Handle the Edit/TextBubble Properties menu option for Harold
*/
void CMainFrame::OnEditEditharoldtextbubble()
{
	mHaroldTextBubbleDrawable->SetTextBubbleProperties();
	mPicture->UpdateObservers();
}

/** \brief Handle the Edit/TextBubble Properties menu option for Sparty
*/
void CMainFrame::OnEditEditspartytextbubble()
{
	mSpartyTextBubbleDrawable->SetTextBubbleProperties();
	mPicture->UpdateObservers();
}
