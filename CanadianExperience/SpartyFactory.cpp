...
std::shared_ptr<CActor> CSpartyFactory::Create()
{
	...
	auto textbubble = make_shared<CTextBubbleDrawable>(L"Sparty Text Bubble");
	textbubble->SetPosition(Point(50, -250));
	mSpartyTextBubbleDrawable = textbubble;
	torso->AddChild(textbubble);
