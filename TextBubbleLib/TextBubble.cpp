...
*/
std::wstring CTextBubble::GetText() const
{
    return mText;
}
...
*/
bool CTextBubble::GetMirror() const
{
    return mMirror;
}
...
*/
void CTextBubble::SetMirrored(bool m)
{
    mMirror = m;  mNewString = true;
}

/** \brief Get the text bubble mirror status
* \returns true if mirrored */
bool CTextBubble::IsMirrored()
{
    return mMirror;
}
...
* \param y Y location
*/
void CTextBubble::SetBubblePosition(int x, int y)
{
